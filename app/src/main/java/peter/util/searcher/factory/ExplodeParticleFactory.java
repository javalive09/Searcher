...
import peter.util.searcher.Utils;
import peter.util.searcher.particle.ExplodeParticle;
...
public class ExplodeParticleFactory extends ParticleFactory{
    ...
    public Particle[][] generateParticles(Bitmap bitmap, Rect bound) {
        ...
        int w = bound.width() == 0 ? 50 : bound.width();
        int h = bound.height() == 0 ? 50 : bound.height();
