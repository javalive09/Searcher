...
public class HistorySearchTab extends LocalViewTab implements View.OnClickListener, View.OnLongClickListener {

    PopupMenu popup;
    MyAsyncTask asyncTask;

    public HistorySearchTab(MainActivity activity) {
        super(activity);
    }

    @Override
    public int onCreateViewResId() {
        return R.layout.tab_history_search;
    }
    ...
    public String getTitle() {
        return mainActivity.getString(R.string.action_search_history);
    }

    @Override
    public String getUrl() {
        return URL_HISTORY_SEARCH;
    }
    ...
    private class HistoryAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            view.setOnClickListener(HistorySearchTab.this);
            view.setOnLongClickListener(HistorySearchTab.this);
            view.setTag(search);
            return view;
        }
    ...
    private class MyAsyncTask extends AsyncTask<Void, Void, List<Bean>> {
        ...
        protected void onPostExecute(List<Bean> beans) {
            ...
            View loading = mainActivity.findViewById(R.id.loading_history_search);
            if (loading != null) {
                loading.setVisibility(View.GONE);
            }

            if (beans != null) {
                ListView history = (ListView) mainActivity.findViewById(R.id.history_search);
                if (history != null) {
